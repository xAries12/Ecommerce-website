...
import { ReviewService } from './../../myreviews/review.service';
...
export class KeyboardDetailComponent implements OnInit {
  ...
  getKeyboardById(id: number): void {
    this.keyboardService
      .getKeyboardById(id)
      .subscribe((keyboard) => {
        this.keyboard = keyboard
        this.reviews = keyboard.reviews
      });
  }
...
export interface AddCommentStats {
  idReview: number
  status: boolean
}
export interface UpdateCommentStats {
  idComment: number
  status: boolean
}
