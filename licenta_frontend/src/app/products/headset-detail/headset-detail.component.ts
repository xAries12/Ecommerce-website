...
@Component({
  selector: 'app-headset-detail',
  templateUrl: './headset-detail.component.html',
  styleUrls: ['./headset-detail.component.scss']
})
export class HeadsetDetailComponent {
  id: number = 0;
  headset?: Headset;
  stars:number =1;
  ...
  getMouseById(id: number): void {
    this.headsetService
      .getHeadsetById(id)
      .subscribe((headset) => {
        this.headset = headset
        this.reviews = headset.reviews
      });
  }
