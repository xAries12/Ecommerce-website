...
export class MotherboardDetailComponent {
  id: number = 0;
  ...
  ngOnInit(): void {
    ...
    this.getMotherboardById(this.id);
    this.loginService.getUser().subscribe(account=>{
      this.account=account;
    });
  }
  getMotherboardById(id: number): void {
    this.motherboardService
      .getMotherboardById(id)
      .subscribe((motherboard) => {
        this.motherboard = motherboard
        this.reviews = motherboard.reviews
      });
  }
